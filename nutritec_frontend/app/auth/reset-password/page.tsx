...
function ResetPasswordContent() { // Crea un componente interno para el contenido
...
export default function ResetPasswordPage() {
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-emerald-50 via-teal-50 to-cyan-50 p-4">
      {/* Envuelve el contenido principal en Suspense */}
      <Suspense fallback={<p>Cargando formulario de restablecimiento de contraseña...</p>}>
