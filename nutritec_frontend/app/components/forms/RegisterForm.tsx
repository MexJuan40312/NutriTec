...
import frutasRegister from "@/app/assets/images/icon_reg.png"
import ErrorAlert from "./ErrorAlert"; // Importa el componente ErrorAlert
...
export default function RegisterForm() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            setSuccessMessage("Revisa tu correo para activar la cuenta.")
    ...
    return (
        <div className="flex flex-col md:flex-row items-center bg-white rounded-3xl shadow-xl overflow-hidden max-w-4xl w-full">
            ...
            >
                ...
                {/* Renderiza el componente ErrorAlert para mostrar mensajes de error y éxito */}
                ...
                <form onSubmit={handleSubmit} className="space-y-5" noValidate>
                    ...
                    <p className="text-center text-sm text-gray-600 mt-6">
                        ¿Ya tienes cuenta?{" "}
                        <a href="../auth/login" className="text-emerald-600 font-medium hover:text-emerald-700 transition-colors">
                            Inicia sesión
                        </a>
                    </p>
                </form>
