...
import { Calendar, Clock, Download, Eye, FileText, Share2, Trash2 } from "lucide-react"
import { useAuth } from "@/app/auth/authContext"

export default function PlanesGeneradosPage() {
  ...
  // Datos de ejemplo para los planes generados
  const planesGenerados = [
    {
      id: 1,
      nombre: "Plan Nutricional - Pérdida de peso",
      fecha: "15/05/2025",
    ...
    {
      id: 3,
      nombre: "Plan Nutricional - Mantenimiento",
      fecha: "01/05/2025",
    ...
    <UserDashboard>
      <div className="py-8 px-4 sm:px-6 md:px-10">
        <div className="max-w-5xl mx-auto">
          {/* Encabezado */}
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-gray-800 dark:text-gray-100 mb-2">Planes Nutricionales Generados</h1>
            <p className="text-gray-600 dark:text-gray-400">
              Hola {userName}, aquí puedes ver todos los planes nutricionales que has generado anteriormente.
            </p>
          </div>

          {/* Lista de planes */}
          <div className="space-y-4">
            {planesGenerados.map((plan) => (
              <motion.div
                key={plan.id}
          ...
          {planesGenerados.length === 0 && (
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-8 text-center border border-gray-100 dark:border-gray-700">
              ...
              <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-2">No hay planes generados</h3>
              <p className="text-gray-600 dark:text-gray-400 mb-6">
                Aún no has generado ningún plan nutricional. ¡Crea tu primer plan ahora!
              </p>
              <a
                href="/dashboard/plan/generar"
